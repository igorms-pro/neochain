...
import { LayoutDashboard, Zap, Gamepad2, Trophy, Wallet, Settings, LogOut, Menu, X } from "lucide-react"
...
const navigation = [
  ...
  { name: "Missions", href: "/app/missions", icon: Zap },
  { name: "Gamification", href: "/app/gamification", icon: Gamepad2 },
